...
Wires the routers, CORS, and a startup hook that creates the database schema
and seeds the database on first run (suitable for the PFA demo; for a
production deployment, use Alembic migrations instead).
"""
import logging
...
app = FastAPI(
    ...
    description=(
        "API du portail de suivi pedagogique avec detection IA des profils a risque. "
